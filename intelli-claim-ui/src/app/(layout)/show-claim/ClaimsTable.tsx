...
export default function ClaimsTable() {
  ...
  const {data: tableData, loading, error, page, setPage, setStatus} = useClaimsData();
        ...
        <div>
          <div className="mt-7 space-y-3">
            ...
            <Tabs size="sm" value={activeTab} variant="underline">
              <ScrollArea>
                <TabsList>
                  <TabsTrigger onClick={(e)=> changeActiveTab(e)} value="all">All</TabsTrigger>
                  <TabsTrigger onClick={(e)=> changeActiveTab(e)} value="pending">Pending</TabsTrigger>
                  <TabsTrigger onClick={(e)=> changeActiveTab(e)} value="approved">Approved</TabsTrigger>
                  <TabsTrigger onClick={(e)=> changeActiveTab(e)} value="rejected">Rejected</TabsTrigger>
                </TabsList>
              </ScrollArea>
              ...
              <TabsContent value={activeTab}>
                ...
                <Flex justify="flex-end" className="mt-3">
                  <Pagination
                    ...
                    onNext={() => setPage(Math.min(page + 1, tableData?.totalPages || 1))}
